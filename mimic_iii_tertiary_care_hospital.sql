...
CREATE TABLE PRESCRIPTION(
    HOSPT_ADM_ID INT,
    PATIENT_ID INT,
    IS_PREVIOUS_APPOINTMENT BOOLEAN,
    IS_CURRENT_APPOINTMENT BOOLEAN,
    IS_SCHEDULED_APPOINTMNENT BOOLEAN,
    APPOINTMENT_DATE DATE,
    APPOINTMENT_TIME TIME,
    VITAL_SIGNS VARCHAR(200),
    FLUID_BALANCE VARCHAR(200),
    CPT_CODE VARCHAR(200))

INSERT INTO PRESCRIPTION VALUES(1,1,1,0,0,'04/15/2019', '14:00', 'Blood pressure: 90/60 mm Hg to 120/80 mm Hg. Breathing: 12 to 18 breaths per minute. Pulse: 60 to 100 beats per minute. Temperature: 97.8°F to 99.1°F (36.5°C to 37.3°C); average 98.6°F (37°C)', '', NULL)
INSERT INTO PRESCRIPTION VALUES(,'11/20/2020', '15:30', NULL, NULL, NULL)
INSERT INTO PRESCRIPTION VALUES(1,1,0,0,1,'11/20/2020', '15:30', NULL, NULL, NULL)
